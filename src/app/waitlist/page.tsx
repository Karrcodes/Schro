...
import {
    Brain, Heart, Wallet, Sparkles,
    Activity, Zap, Palette,
    Check, Compass
} from 'lucide-react'
...
// ─── Platform Demo Components (Shared with Login) ───────────────────────────
...
export default function WaitlistPage() {
    ...
    return (
        <div className="h-screen overflow-hidden bg-[#fafafa] flex font-outfit">
            {/* ── Left Column: Identity Capture ─────────────────────────── */}
            <div className="w-full lg:w-[40%] flex flex-col p-8 md:p-10 lg:p-16 relative z-10 bg-white shadow-2xl">
                <div className="flex-1 max-w-sm mx-auto w-full flex flex-col justify-center">
                    ...
                    <div className="mb-10">
                        ...
                        <p className="text-[13px] text-black/40 font-medium">
                            Enter your invite code to synchronize your identity.
                        </p>
                                ...
                                >
                                    ...
                                    <div className="relative z-10 flex items-start gap-4">
                                        ...
                                        <div className="space-y-1">
                                            <p className="text-[14px] font-bold text-black tracking-tight">Access Granted.</p>
                                            <p className="text-[12px] font-medium text-black/40 leading-relaxed">
                                                Identity verified. Initializing neural sync with the core architecture.
                                            </p>
                                        </div>
                                    </div>
                                    <div className="mt-4 pt-4 border-t border-black/[0.04] flex items-center justify-between">
                                        <span className="text-[9px] font-black uppercase tracking-[0.2em] text-emerald-500">Redirecting to Control Centre</span>
                                        <Sparkles className="w-3 h-3 text-emerald-500/30" />
                                    </div>
                                </motion.div>
                            ) : (
                                <div className="space-y-4">
                                    <form onSubmit={handleRedeemCode} className="relative group">
                                        <input
                                            type="text"
                                            value={code}
                                            onChange={e => setCode(e.target.value.toUpperCase())}
                                            placeholder="ENTER INVITE CODE"
                                            className="w-full h-12 px-6 bg-white border border-black/[0.08] rounded-2xl text-[13px] font-bold uppercase tracking-widest placeholder:text-black/20 focus:outline-none focus:border-black/20 focus:bg-black/[0.01] transition-all"
                                            disabled={loading}
                                            required
                                        />
                                        <button
                                        ...
                                        >
                                            {loading ? 'Verifying...' : 'Redeem Access'}
                                        </button>
                                    </form>
                ...
                <div className="flex items-center justify-between mt-auto">
                    <div className="text-[10px] font-bold text-black/15 uppercase tracking-[0.2em]">
                        System v1.2.0
                    </div>
                    <button
                        onClick={signOut}
                        className="text-[10px] font-bold text-black/40 hover:text-black uppercase tracking-[0.2em] transition-colors"
                    >
                        Sign out
                    </button>
                </div>
