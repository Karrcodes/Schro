                ...
                <div className="max-w-7xl mx-auto w-full px-6 md:px-10 pb-12 space-y-12">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
                        {routines.length === 0 ? (
                            ...
                            <>
                                {/* Active Protocol */}
                                <section className="bg-black text-white rounded-[32px] p-8 relative overflow-hidden flex flex-col group shadow-2xl h-auto md:h-[320px] lg:h-auto lg:min-h-full lg:col-span-1 max-w-[400px] mx-auto lg:max-w-none lg:mx-0 w-full">
                                ...
                                {/* Milestones */}
                                <div className="lg:col-span-1 h-auto relative max-w-[400px] mx-auto lg:max-w-none lg:mx-0 w-full">
                                    <MilestoneTracker />
                                </div>
                            </>
                        )}
