...
function SectionBlock({ title, desc, children, className, extra }: { title?: string; desc?: string; children: React.ReactNode; className?: string; extra?: React.ReactNode }) {
    return (
                    ...
                    <div className="max-w-7xl mx-auto w-full space-y-12 pb-12">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                                <SummaryCard
                                    label="Main Account"
                                    value={(loading || isSyncing) ? "0000.00" : `£${pots
                                        .filter(p => 
                                    ...
                                    color="#7c3aed"
                                    sub={`Monzo ${activeProfile === 'personal' ? 'Personal' : 'Business'}`}
                                    tooltip="Current balance in your main General or Joint account."
                                />
                                <SummaryCard
                            ...
                            <div className="space-y-12">
                                <div className="grid grid-cols-1 gap-12">
                                    ...
                                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 items-stretch">
                                        ...
                                        <SectionBlock 
                                            title="Savings Goals" 
                                            desc="Long-term targets" 
                                            className="flex flex-col min-h-[420px]"
                                            extra={
                                                <div className="text-right">
                                                    <div className="text-[14px] font-black text-black tracking-tight privacy-blur">
                                                        £{combinedGoals.reduce((s, g) => s + (g.current_amount || 0), 0).toLocaleString(undefined, { minimumFractionDigits: 2 })}
                                                    </div>
                                                    <div className="text-[9px] uppercase tracking-wider font-bold text-emerald-500">Total Saved</div>
                                                </div>
                                            }
                                        >
                                            <div className="flex-1 overflow-y-auto no-scrollbar">
